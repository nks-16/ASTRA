...
const TeamSchema = new mongoose_1.Schema({
    ...
    leaderId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'User', required: true },
    ...
    problemStatementId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'ProblemStatement' },
});
